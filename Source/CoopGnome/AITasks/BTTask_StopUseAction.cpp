...
#include "BTTask_StopUseAction.h"
...
UBTTask_StopUseAction::UBTTask_StopUseAction(const FObjectInitializer& ObjectInitializer)
{
	bCreateNodeInstance = true;
	NodeName = "Stop Action";
}

EBTNodeResult::Type UBTTask_StopUseAction::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	if(ActionActor->StopAction(Character))
